...
## the script assumes filtered called peaks of the format <cellype>_<mark>.bed

NAME=$1  ## common prefix in BED files to be processed, e.g. [proB]_H3K27ac, [proB]_H3K4me1, etc
WFILE=$2 ## genomic windows - eg 200bp, make with "bedtools makewindows -g hg19.chrom.sizes -w 200 > hg19.200bp_windows.bed"
CHROMSIZES=$3
